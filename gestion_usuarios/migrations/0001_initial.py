...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                'permissions': (('registrar_rol', 'Puede Registrar Rol'), ('consultar_roles', 'Puede Consultar Roles'), ('actualizar_rol', 'Puede Actualizar Rol'), ('eliminar_rol', 'Puede eliminar Rol')),
                'managed': False,
                'default_permissions': (),
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'ordering': ['-first_name'],
                'permissions': (('registrar_usuario', 'Puede Registrar Usuario'), ('consultar_usuarios', 'Puede Consultar Usuarios'), ('actualizar_usuario', 'Puede Actualizar Usuario'), ('eliminar_usuario', 'Puede Eliminar Usuario'), ('detalle_usuario', 'Puede Ver Detalle Usuario')),
                'default_permissions': (),
            },
            managers=[
